...
public class Main {
    ...
    static class surec {
        String surec_adi;
        int gelis_zamani;
        int islem_suresi;      // orijinal burst
        int kalan_sure;        // remaining time
        int bitis_zamani = -1;
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < args.length; i++) {
            ...
            sjf_preemptive_calistir_ve_yaz(surecler, cikti_dosyasi);
    ...
    static String cikti_adi_uret(String giris_dosyasi) {
        ...
        return "sonuclar/SJF_preemptive_" + ad + ".txt";
    }
    ...
    static void sjf_preemptive_calistir_ve_yaz(List<surec> surecler, String cikti_yolu) throws Exception {
        ...
        if (!surecler.isEmpty()) {
            ...
            int ilk_gelis = surecler.get(0).gelis_zamani;
            if (ilk_gelis > 0) {
                zaman_parcasi_ekle(baslangic_zamanlari, bitis_zamanlari, calisan_etiketler, 0, ilk_gelis, "BOSTA");
                onceki_etiket = "BOSTA";
                zaman = ilk_gelis;
            }
        }
            ...
            for (surec s : surecler) {
                ...
                if (!s.tamamlandi && s.gelis_zamani <= zaman) {
                    if (secilen == null) {
                        ...
                        if (s.kalan_sure < secilen.kalan_sure) {
                            secilen = s;
        ...
        cikti.append("Algoritma: SJF Preemptive \n\n");
