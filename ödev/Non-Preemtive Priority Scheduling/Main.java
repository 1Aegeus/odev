...
public class Main {
    ...
    static class surec {
        ...
        int gelis_zamani;
        int islem_suresi;
        int oncelik;          // kucuk = daha oncelikli
        int bitis_zamani = -1;
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length < 1) {
            System.out.println("Kullanim: java Main <case1.csv> [case2.csv] ...");
            return;
        }
        ...
        for (int i = 0; i < args.length; i++) {
            ...
            priority_nonpreemptive_calistir_ve_yaz(surecler, cikti_dosyasi);
    ...
    static String cikti_adi_uret(String giris_dosyasi) {
        ...
        return "sonuclar/PRIORITY_" + ad + ".txt";
    }
    ...
    // CSV: Process_ID,Arrival_Time,CPU_Burst_Time,Priority
    static List<surec> csv_oku(String dosya_yolu) throws Exception {
        ...
        // deterministik: once gelis, sonra ad
        liste.sort((a, b) -> {
    ...
    static void priority_nonpreemptive_calistir_ve_yaz(List<surec> surecler, String cikti_yolu) throws Exception {
        ...
        cikti.append("Algoritma: Priority Non-Preemptive\n\n");
